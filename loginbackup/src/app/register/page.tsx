...
export default function Register() {
    ...
    return (
        <section className="bg-gray-100 h-screen flex items-center justify-center px-4 py-10">
            <div className="flex items-center justify-center w-full max-w-md px-4 py-8">
                <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-sm">
                    ...
                    <form action="#" method="POST" className="mt-6 space-y-5">
                        <div>
                            <label htmlFor="username" className="text-base font-medium text-gray-900 flex items-center">
